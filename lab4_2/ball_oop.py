...
def draw_leaderboard(leaderboard):
    ...
    draw_text("Press SPACE to start the game", font_sml, y + font_sml.size("1")[1]//2)


leaderboard = load_leaderboard("scores.txt")
while not QUIT_EVENT:
    ...
    if event.type == pygame.QUIT:
        ...
        if event.key == pygame.K_SPACE:
            ...
            update_leaderboard(score, leaderboard)
            do_game_over(2000, score)
    
pygame.quit()
save_leaderboard("scores.txt", leaderboard)
